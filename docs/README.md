...
- `features.md`  
  - 완료 수정, QA·Dev 종료 파이프라인·QA URL 추론 경고, UI 스캐폴드·별칭, Next 코드 생성 가이드(§11b), 라우트 루트 일관성(§11c), `write_code` RSC/metadata 방어(§11d), 플랜 스킬·`scan_project`(§11e), 리뷰, discuss, enhance-prompt, TTS, 동적 스택 분석, 미설치 패키지 방어 등
- `api.md`  
